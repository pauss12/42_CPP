...
/*   Updated: 2026/01/17 18:37:35 by pmendez-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(const ClapTrap &orig)
{
	...
	std::cout << "ClapTrap" << this->getName() << " has been created with copy constructor " << std::endl;
}
...
ClapTrap& ClapTrap::operator=(const ClapTrap& orig)
{
	...
	std::cout << "ClapTrap " << this->getName() << " has been created with assignment operator " << std::endl;
	return (*this);
}
